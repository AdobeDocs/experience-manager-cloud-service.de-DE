...
| **[!UICONTROL Zugeschnittene Inhalte für alle Zielauflösungen beibehalten]** | So halten Sie den Zuschnittinhalt über das gleiche Seitenverhältnis | Verwenden Sie diese Option, wenn Sie ein Profil für smartes Zuschneiden erstellen.<br>Deaktivieren Sie diese Option, um neuen Zuschnittinhalt zu generieren, wobei der Fokus weiterhin beibehalten wird, und zwar für ein bestimmtes Seitenverhältnis über verschiedene Auflösungen hinweg.<br>Wenn Sie dieses Kontrollkästchen deaktivieren, stellen Sie sicher, dass die Originalbildauflösung größer ist als die für Ihr Profil für smartes Zuschneiden definierten Auflösungen.<br><br>Angenommen, Sie haben die Seitenverhältnisse auf 600 x 600 (groß), 400 x 400 (mittel) und 300 x 300 (klein) eingestellt.<br>Wann **[!UICONTROL Bewahren Sie den Zuschnittinhalt über Zielauflösungen hinweg auf]** Option ist *aktiviert*, sehen Sie denselben Zuschnitt für alle drei Auflösungen ähnlich der folgenden Beispielausgabe von Bildern (nur zu Veranschaulichungszwecken):<br>![Option aktiviert](/help/assets/dynamic-media/assets/preserve-checked.png)<br><br>Wann **[!UICONTROL Bewahren Sie den Zuschnittinhalt über Zielauflösungen hinweg auf]** Option ist *deaktiviert*, ist der Zuschnittinhalt für alle drei Auflösungen neu und ähnelt der folgenden Beispielausgabe von Bildern (nur zu Veranschaulichungszwecken):<br>![Option deaktiviert](/help/assets/dynamic-media/assets/preserve-unchecked.png) |
