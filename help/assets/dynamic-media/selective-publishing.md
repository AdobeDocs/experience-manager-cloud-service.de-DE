...
description: Erfahren Sie, wie Sie mit Selektive Veröffentlichung in Dynamic Media arbeiten.
...
Sie können Assets in Adobe Experience Manager oder Dynamic Media veröffentlichen oder deren Veröffentlichung rückgängig machen. Sie können dies auf Ordnerebene tun, indem Sie entweder **[!UICONTROL Veröffentlichung verwalten]** oder **[!UICONTROL Quick Publish]** verwenden. Diese Veröffentlichungsmethode ist nützlich, da sie sich nicht nur auf die **[!UICONTROL Dynamic Media-Konfiguration]** beschränkt, deren Einstellungen für alle Ordner in Ihrer Dynamic Media-Instanz global sind.
...
1. Tippen Sie in Experience Manager auf das Experience Manager-Logo, um auf die globale Navigationskonsole zuzugreifen. Tippen Sie auf der linken Seite auf das Navigationssymbol (direkt über dem Werkzeugsymbol) und dann auf **[!UICONTROL Assets]** > **[!UICONTROL Dateien]**.
...
## Selektive Veröffentlichung von Assets in Dynamic Media oder Experience Manager as a Cloud Service mithilfe von &quot;Veröffentlichung verwalten{#selective-publish-manage-publication}&quot;
...
**So veröffentlichen Sie Assets mit &quot;Veröffentlichung verwalten&quot;selektiv in Dynamic Media oder Experience Manager as a Cloud Service:**
...
1. Wählen Sie auf der Seite **[!UICONTROL Veröffentlichung verwalten – Optionen]** unter **[!UICONTROL Aktion]** den gewünschten Aktivierungstyp aus.
   ...
   | **[!UICONTROL In Dynamic Media veröffentlichen]** | Wenn Sie Assets in Dynamic Media veröffentlichen möchten, um sie öffentlich bereitzustellen oder Funktionen wie smartes Zuschneiden oder dynamische Ausgabedarstellungen verwenden zu können, wählen Sie diese Option aus.<br>Diese Option ist nur verfügbar, wenn in den Eigenschaften des Ordners der **[!UICONTROL Veröffentlichungsmodus für Dynamic Media]** auf **[!UICONTROL Selektive Veröffentlichung]** gesetzt ist. |
...
1. Wählen Sie auf der Seite **[!UICONTROL Veröffentlichung verwalten – Optionen]** unter **[!UICONTROL Aktion]** die gewünschte Art der Deaktivierung aus.
   ...
   | Aktion | Beschreibung |
   | --- | --- |
   | **[!UICONTROL Veröffentlichung rückgängig machen]**  (vom Experience Manager) | Um die Veröffentlichung von Assets in Experience Manager rückgängig zu machen, wählen Sie diese Option aus. |
   | **[!UICONTROL Veröffentlichung in Dynamic Media rückgängig machen]** | Um die Veröffentlichung von Assets in Dynamic Media rückgängig zu machen, wählen Sie diese Option aus.<br>Diese Option ist nur verfügbar, wenn in den Eigenschaften des Ordners der **[!UICONTROL Veröffentlichungsmodus für Dynamic Media]** auf **[!UICONTROL Selektive Veröffentlichung]** gesetzt ist. |
...
1. Tippen Sie in Experience Manager auf das Experience Manager-Logo, um auf die globale Navigationskonsole zuzugreifen. Tippen Sie links auf der Seite auf das Navigationssymbol (direkt über dem Werkzeugsymbol) und dann rechts auf der Seite auf **[!UICONTROL Assets]** > **[!UICONTROL Dateien]**.
1. Führen Sie in der **[!UICONTROL Kartenansicht]**, **[!UICONTROL Spaltenansicht]** oder **[!UICONTROL Listenansicht]** einen der folgenden Schritte aus:
...
1. Tippen Sie in der Symbolleiste auf **[!UICONTROL Veröffentlichung verwalten]**. Tippen Sie ggf. auf das Symbol mit den Auslassungszeichen in der Symbolleiste, um **[!UICONTROL Veröffentlichung verwalten]** anzuzeigen.
