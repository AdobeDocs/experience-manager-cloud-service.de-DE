...
| `Authorization` | Entsprechende Benutzeranmeldeinformationen der Autorin oder des Autors (Authentifizierungstyp: Standardauthentifizierung) | Erforderlich | Fügen Sie den entsprechenden Benutzernamen und das Passwort hinzu. |
