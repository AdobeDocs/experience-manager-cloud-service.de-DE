...
[!DNL Experience Manager Assets] as a [!DNL Cloud Service] basiert auf [!DNL Adobe Experience Manager] und entspricht gut dem neuesten Angebot [!DNL Experience Manager] 6.5. Das [!DNL Cloud Service]-Angebot verfügt über eine angepasste Architektur und Funktionalität, die es ermöglicht, ein Cloud-nativer Service zu sein. Aufgrund von Änderungen an der zugrunde liegenden Architektur weist [!DNL Cloud Service] nicht alle Funktionen von Adobe Experience Manager 6.5 auf.
