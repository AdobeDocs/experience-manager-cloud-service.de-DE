...
Die neue Version der aem-sdk-api enthält Klassen, die mit einem Java 11-Ziel kompiliert wurden, das nicht mit der standardmäßigen JDK-Version 1.8 der Cloud Manager-Build-Umgebung kompatibel ist. Diese Aktualisierung erfordert, dass Maven mit JDK 11 ausgeführt wird.
...
* SITES-8831 – Inhaltsfragment-Steuerungsebene – PUT – Aktualisieren eines Fragments mit vollständigen Informationen
...
* ASSETS-26368: Geplante Massenimportvorgänge werden nicht entfernt, wenn die Auftragskonfiguration nicht vorhanden ist.
...
* ASSETS-33454: Die Aktivität „Aufgabe überprüfen“ und Kommentare dazu werden nicht in der Timeline angezeigt.
