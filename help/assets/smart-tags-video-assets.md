...
Die Videodateiformate (und ihre Codecs), die für intelligentes Tagging unterstützt werden, sind MP4 (H264/AVC), MKV (H264/AVC), MOV (H264/AVC, Motion JPEG), AVI (indeo4), FLV (H264/AVC, vp6f) und WMV (WMV2). Darüber hinaus ermöglicht die Funktion das Tagging von Videos bis zu einer Größe von 300 MB. Das automatisierte Tagging von Video-Assets erfolgt als standardmäßige Asset-Verarbeitung (zusammen mit der Erstellung von Miniaturbildern und der Metadaten-Extraktion), nachdem ein Video hochgeladen wurde oder eine erneute Verarbeitung ausgelöst wird. Die Smarttags werden in absteigender Reihenfolge ihres [Konfidenzwerts](#confidence-score-video-tag) in den Asset- [!UICONTROL Eigenschaften]angezeigt. Video-Tagging ist standardmäßig [!DNL Adobe Experience Manager] als Cloud Service aktiviert. Sie können [das intelligente Tagging](#opt-out-video-smart-tagging) für Videos in einem Ordner jedoch deaktivieren.

## Smart-Tagging-Videos beim Hochladen {#smart-tag-assets-on-ingestion}

Beim [Hochladen von Video-Assets](add-assets.md#upload-assets) [!DNL Adobe Experience Manager] als Cloud Service werden die Videos ![verarbeitet](assets/do-not-localize/assetprocessing.png). Sobald die Verarbeitung abgeschlossen ist, finden Sie auf der Seite &quot;Asset- [!UICONTROL Eigenschaften&quot;auf der Registerkarte &quot;] Einfach  &quot;. Intelligente Tags werden dem Video unter &quot; [!UICONTROL Intelligente Tags]&quot;automatisch hinzugefügt. Der Asset Compute-Dienst nutzt Adobe Sensei, um diese Smarttags zu erstellen.
...
Die angewendeten Smart-Tags werden in absteigender Reihenfolge nach dem [Konfidenzwert](#confidence-score-video-tag)sortiert, kombiniert mit Objekt- und Aktionstag, innerhalb von [!UICONTROL Smart-Tags].
...
Die bereits vorhandenen Video-Assets in DAM werden nicht automatisch mit intelligenten Tags versehen. Sie müssen Assets [!UICONTROL manuell] verarbeiten, um Smarttags für sie zu generieren.
...
1. Wählen Sie das [!DNL Adobe Experience Manager] Logo aus und wählen Sie dann Assets auf der [!UICONTROL Navigationsseite] aus.
...
1. Klicken Sie auf das Symbol ![Assets](assets/do-not-localize/reprocess-assets-icon.png) neu verarbeiten [!UICONTROL auf Assets] und wählen Sie die Option [!UICONTROL Vollständiger Prozess] .

![Assets neu verarbeiten, um Videos im DAM-Repository Tags hinzuzufügen](assets/reprocess.gif)

Nach Abschluss des Vorgangs navigieren Sie zur Seite &quot; [!UICONTROL Eigenschaften] &quot;eines Videoassets im Ordner. Die automatisch hinzugefügten Tags werden auf der Registerkarte &quot; [!UICONTROL Einfach] &quot;im Abschnitt &quot;Smart-Tags&quot;angezeigt  . Diese angewendeten Smarttags werden in absteigender Reihenfolge nach dem [Konfidenzwert](#confidence-score-video-tag)sortiert.

## Suchen nach Videos mit Tags {#search-smart-tagged-videos}

Verwenden Sie [Omniture Search, um nach Video-Assets zu suchen, die auf den automatisch generierten Smart-Tags basieren](search-assets.md#search-assets-in-aem):

1. Wählen Sie das ![Suchsymbol](assets/do-not-localize/search_icon.png) aus, um das Suchfeld Omniture anzuzeigen.
...
Weitere Informationen zum Moderieren der Smarttags für Assets finden Sie unter [Verwalten von Smarttags](smart-tags.md#manage-smart-tags-and-searches).

![Moderieren von Smart-Tags für Videos](assets/manage-video-smart-tags.png)

>[!NOTE]
>
>Alle Tags, die mithilfe der Schritte unter [Verwalten von Smarttags](smart-tags.md#manage-smart-tags-and-searches) moderiert werden, werden bei der Wiederaufarbeitung des Assets nicht gespeichert. Der ursprüngliche Tag-Satz wird erneut angezeigt.

## Opt-out von intelligentem Tagging für Videos {#opt-out-video-smart-tagging}
...
1. Im Menü &quot; [!UICONTROL Smart-Tags für Videos] &quot;ist die Option &quot; [!UICONTROL Vererbt] &quot;standardmäßig aktiviert und &quot;Video-Smart-Tag&quot;ist aktiviert.

   Wenn die Option &quot; [!UICONTROL Vererbt] &quot;aktiviert ist, wird der Pfad des geerbten Ordners zusammen mit den Informationen angezeigt, ob er auf &quot; [!UICONTROL Aktivieren] &quot;oder &quot; [!UICONTROL Deaktivieren]&quot;eingestellt ist.

   ![Deaktivieren der intelligenten Tagging-Funktion für Videos](assets/disable-video-tagging.png)

1. Wählen Sie [!UICONTROL Deaktivieren] Sie die Option &quot;Intelligentes Tagging von in den Ordner hochgeladenen Videos Opt-out&quot;.

>[!IMPORTANT]
>
>Wenn Sie sich zum Zeitpunkt des Hochladevorgangs dafür entschieden haben, Videos in einem Ordner mit Tags zu versehen, und die Videos nach dem Hochladen mit einem intelligenten Tag versehen möchten, **[!UICONTROL aktivieren Sie Smart Tags für Videos]** auf der Registerkarte &quot; [!UICONTROL Asset-Verarbeitung] &quot;der Ordnereigenschaften [!UICONTROL und verwenden Sie die Option &quot;Asset] [[!UICONTROL neu verarbeiten&quot;]](#smart-tag-existing-videos) , um dem Video Smart-Tags hinzuzufügen.

## Vertrauensbewertung {#confidence-score-video-tag}
...
So fügen Sie die OSGI-Konfidenzwert-Konfiguration zum Projekt hinzu, das über Cloud Manager als Cloud Service bereitgestellt [!DNL Adobe Experience Manager] wird:

* Schließen Sie im [!DNL Adobe Experience Manager] Projekt (`ui.config` seit Archetype 24 oder früher `ui.apps`) die `config.author` OSGi-Konfiguration eine Konfigurationsdatei mit dem Namen `com.adobe.cq.assetcompute.impl.senseisdk.SenseiSdkImpl.cfg.json` mit folgendem Inhalt ein:
