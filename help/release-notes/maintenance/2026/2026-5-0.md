...
>[!IMPORTANT]
>
>Diese Version aktualisiert die Java Runtime Environment auf Version 21.0.10 ([Versionshinweise](https://www.oracle.com/java/technologies/javase/21-0-10-relnotes.html)).
>Dieses Upgrade deaktiviert die `TLS_RSA` Chiffrier-Suites, da sie die Vorwärtsgeheimnis nicht wahren.
>Versuche, mithilfe von Chiffre-Suites, die mit `TLS_RSA_` beginnen, von AEM aus auf externe Systeme zuzugreifen, schlagen mit einem `SSLHandshakeException` fehl.
