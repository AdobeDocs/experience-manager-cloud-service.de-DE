...
badgePremium: label="Early Adopter" type="Positive" url="/help/implementing/cloud-manager/release-notes/current.md
...
# Hinzufügen von externen Repositorys in Cloud Manager – Early Adopter {#external-repositories}
