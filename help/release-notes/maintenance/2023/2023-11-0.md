...
* ASSETS-29631: Assets Cloud: Verwenden Sie dam:roles für einen sicheren Versand bzw. eine sichere Suche.
...
* SITES-16853: Inhaltsfragmente: Entfernen Sie den Endpunkt /adobe/sites/cf/fragments/{fragmentId}/variation/{name}/tags.
...
* SITES-15373: Inhaltsfragmente: Der Endpunkt /adobe/sites/cf/fragments/{fragmentId}/variation/{name}/tags verwendet nicht die richtigen Konventionen zur Benennung von Ressourcen.
...
* SITES-15782: Inhaltsfragmente: Fehlende eindeutige Eigenschaft vom Feldmodell des Typs „Aufzählung“.
...
* SITES-16079: Inhaltsfragmente: /fragments/{id}/references started to return duplicates.
...
* SITES-16707: Inhaltsfragmente: Datentyp „Inhaltsfragmentmodell“ wird nicht korrekt gelesen.
...
* ASSETS-28566: Hinzufügen von dam:metadataForm Lucene-Index.
...
* ASSETS-29056: Hinzufügen von Transkodierungsausgabedarstellungen zum standardmäßigen AEM-Verarbeitungsprofil.
* ASSETS-29105: Einschränkungsanbieter fehlt in SecurityProviderRegistration requiredServicePids im RDE-Funktionsmodell.
* ASSETS-29106: Fehler „Auf Adobe Stock anzeigen“ wird auf Unified Shell-aktiviertem AEM ausgelöst.
...
* ASSETS-29689: dc:roles (und die neue Eigenschaft dam:roles) sollte aus AEM gefiltert werden.
...
* ASSETS-30167: HTML für adobe_dam:restrictions funktioniert nach dem Hochladen eines Assets nicht mehr.
