...
1. Abrufen von Adobe I/O CLI mit dem Cloud Manager-Plug-in
...
Komplexere Setups mit mehreren AEM-Website-Strukturen in Kombination mit verschiedenen Commerce-Katalogen finden Sie im Tutorial [Einrichten von mehreren Commerce-Stores](configuring/multi-store-setup.md).
...
- [Einrichtung mehrerer Commerce-Systeme](configuring/multiple-commerce-systems-setup.md)
