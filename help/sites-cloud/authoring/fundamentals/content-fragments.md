...
description: Mit Adobe Experience Manager als Inhaltsfragmenten für Cloud-Dienste können Sie seitenunabhängige Inhalte entwerfen, erstellen, kuratieren und verwenden.
...
>* **Erlebnisfragmente** sind vollständig formatierte Inhalte und somit Fragmente einer Webseite.
>
>
...
4. Initially the content from the **Main** Element and **Master** (variation) will be shown. Sie können nach Bedarf aber [auch andere Elemente und/oder Variationen auswählen](#selecting-the-element-or-variation).
