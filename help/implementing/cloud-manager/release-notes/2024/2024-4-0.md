...
* Der Löschvorgang wurde für [Edge Delivery](/help/edge/overview.md) -Websites verbessert, indem die Domänenzuordnungen aus dem Programm aktualisiert wurden, das sich auf diese Site bezieht.
