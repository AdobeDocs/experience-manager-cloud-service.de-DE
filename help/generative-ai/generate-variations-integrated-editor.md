...
>[!NOTE]
>
>Es wird empfohlen, diese Version zu verwenden, da die eigenständige Version von [Varianten generieren“ zwar noch direkt zugänglich ](/help/generative-ai/generate-variations.md), in Zukunft jedoch nicht mehr unterstützt wird.
...
>[!NOTE]
>
>Im [Sicherheits-Factsheet“ finden Sie Einzelheiten zur Generierung von Varianten in AEM](https://www.adobe.com/content/dam/cc/en/trust-center/ungated/whitepapers/experience-cloud/aem-sites-generate-variations-security-fact-sheet.pdf).
...
Der Zugriff über den [universellen Editor von AEM](/help/sites-cloud/authoring/universal-editor/authoring.md) wird als Erweiterung implementiert. Weitere Informationen finden Sie unter [Extension Manager in AEM Experience Manager](https://developer.adobe.com/uix/docs/extension-manager/).
