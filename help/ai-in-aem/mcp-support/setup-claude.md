...
![Der Dialog Claude-Einstellungen.](assets/claude-1.png)

![Das Anschlussfeld in Claude.](assets/claude-2.png)

![Hinzufügen eines benutzerdefinierten Connectors in Claude.](assets/claude-3.png)

![Verbinden des benutzerdefinierten Connectors in Claude.](assets/claude-4.png)

![Das benutzerdefinierte Connector-Konfigurationsformular in Claude.](assets/claude-5.png)

![Das Dialogfeld „Tool-Berechtigungen“ für den benutzerdefinierten Connector.](assets/claude-6.png)

![Claude wird aufgefordert, den AEM Content MCP Service zu verwenden.](assets/claude-7.png)
