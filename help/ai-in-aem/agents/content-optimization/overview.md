...
* **[Nahtlose Zusammenarbeit mit dem Discovery Agent](/help/ai-in-aem/agents/discovery/overview.md)**: Baut auf den vom Discovery Agent identifizierten Assets auf und ermöglicht den End-to-End-Abruf und die Optimierung von Assets durch natürliche Konversation.
...
* **Erstellung von Ausgabedarstellungen mit hoher Auflösung**
  ...
  Suchen Sie mit dem [Discovery-Agent](/help/ai-in-aem/agents/discovery/overview.md) nach dem richtigen Asset und verwenden Sie dann bei mehreren Suchergebnissen die folgenden Eingabeaufforderungen:
