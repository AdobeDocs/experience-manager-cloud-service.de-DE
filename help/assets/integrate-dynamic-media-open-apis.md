...
Sie können entweder Ihre eigene benutzerdefinierte Benutzeroberfläche mit dem Experience Manager Assets-Repository integrieren, indem Sie die Such- und Bereitstellungs-APIs verwenden, oder Sie verwenden Adobe Content Advisor.
...
Content Advisor bietet eine Benutzeroberfläche, die sich problemlos in das [!DNL Experience Manager Assets as a Cloud Service]-Repository integrieren lässt, sodass Sie genehmigte digitale Assets, die im Repository verfügbar sind, durchsuchen und für die Erstellung von Applikationen verwenden können. Weitere Informationen finden Sie unter [Content Advisor](/help/assets/integrate-adobe-non-adobe-applications.md).
