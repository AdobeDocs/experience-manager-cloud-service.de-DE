...
| --- | --- |
| **[!UICONTROL Ebenen beibehalten]** | Teilt die Ebenen im PSD (falls vorhanden) in einzelne Assets. Die Asset-Ebenen bleiben mit der PSD verknüpft. Sie können sie anzeigen, indem Sie die PSD-Datei in der Detailansicht öffnen und das Ebenenfenster auswählen. Weitere Informationen finden Sie unter „Anzeigen und Bearbeiten von Ebenen in einer PSD-Datei“. |
