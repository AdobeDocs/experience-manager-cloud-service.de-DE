...
Im vorherigen Dokument der AEM Sites-Übersetzungs-Journey [Erste Schritte mit der AEM Sites-Übersetzung](learn-about.md) haben Sie gelernt, wie Sie Ihre Inhalte organisieren und wie AEM Übersetzungs-Tools funktionieren. Jetzt sollten Sie:
...
* Ob andere Inhalte übersetzt werden sollen, die mit den Seiten verknüpft sind, z. B. Tags
...
1. Klicken oder tippen Sie in der Symbolleiste auf **Erstellen** , um die neue Konfiguration zu erstellen.
...
1. Da Ihr Inhalt als Sites verwaltet wird, tippen oder klicken Sie auf die Registerkarte **Sites** .
...
1. Geben Sie die folgenden Informationen ein.
   ...
   1. **Seiten-Assets übersetzen**  - Wählen Sie  **Mit Sites-Übersetzungs-Workflow** aus, um die mit den Siteseiten verknüpften Assets zu übersetzen.
   1. **Komponentenzeichenfolgen übersetzen**  - Aktivieren Sie diese Option, um Komponenteninformationen zu übersetzen.
   1. **Tags übersetzen**  - Aktivieren Sie diese Option, um Tags zu übersetzen, die mit der Seite verknüpft sind.
...
Verschaffen Sie sich diese Kenntnisse und setzen Sie die Journey Ihrer AEM Sites-Übersetzung fort, indem Sie sich das Dokument [Übersetzungsregeln konfigurieren](translation-rules.md) ansehen. Hier erfahren Sie, wie Sie festlegen, welche Inhalte übersetzt werden sollen.

## Zusätzliche Ressourcen {#additional-resources}

Es wird empfohlen, zum nächsten Teil der Journey zu wechseln, indem Sie das Dokument [Übersetzungsregeln konfigurieren](translation-rules.md) lesen. Im Folgenden finden Sie einige zusätzliche optionale, die einen tieferen Einblick in einige der in diesem Dokument erwähnten Konzepte ermöglichen, jedoch nicht auf dem Journey weiterarbeiten müssen.
