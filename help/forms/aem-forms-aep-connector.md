...
1. Wählen Sie auf **Registerkarte** Quelle“ eine Vorlage aus
1. Wählen Sie auf **Registerkarte** die Option **Adobe Experience Platform** aus.

1. Wählen Sie im Eigenschaftenbereich Ihre Cloud-Konfiguration aus. Das System lädt alle verfügbaren Schemata aus Adobe Experience Platform
...
**F: Kann ich diesen Connector mit einer beliebigen Version von AEM Forms verwenden?**
A: Nein, diese Integration ist nur für AEM Forms as a Cloud Service im Rahmen des Early Access-Programms verfügbar.

**F: Funktioniert dieser Connector sowohl mit Kernkomponenten von Adaptive Forms als auch mit Foundation-Komponenten?**
A: Dieser Connector funktioniert am besten mit Kernkomponenten von Adaptive Forms, was der empfohlene Ansatz für alle neuen Formulare ist.

**F: Kann ich Daten von einem einzigen Formular an mehrere AEP-Datensätze senden?**
A.: Derzeit kann jedes Formular nur an einen Datensatz gesendet werden. Für mehrere Datensatzübermittlungen müssen Sie benutzerdefinierte Workflows erstellen.

**F: Gibt es eine Begrenzung dafür, wie viele Formularübermittlungen verarbeitet werden können?**
A.: Formularübermittlungen unterliegen Ihren AEP-Streaming-Aufnahmequoten und -Ratenbeschränkungen.

**F: Können Formularanhänge an AEP gesendet werden?**
A: Nein, Formularanhänge können nicht direkt an AEP gesendet werden. Sie müssten Anhänge separat speichern und nur Metadaten an AEP senden.
