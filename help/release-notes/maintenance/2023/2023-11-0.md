...
* ASSETS-25199: Bildkernkomponente, die keine richtigen smarten Zuschnitte anzeigt.
...
* ASSETS-28634: Das OmniSearch-Feld im Adobe-Stock erhält keine automatischen Asset-Daten.
* ASSETS-28727: In der Liste &quot;Konfiguration von Verarbeitungsprofilen&quot;werden die angegebenen benutzerdefinierten Höhen- und Breitenwerte nicht angezeigt.
...
* ASSETS-29106: Adobe-Stock-Ansicht gibt Fehler bei AEM mit Unified Shell aus.
* ASSETS-29115: Entfernen Sie die Konfigurationseigenschaft für Pfade des Beschränkungsanbieters.
* ASSETS-29208: Fehler beim Hochladen von Assets, die durch an einen Autoren-Pod gesendete Anfragen verursacht wurden, bevor der Dienst CompleteUploadAssetServlet registriert wurde.
* ASSETS-29297: Problem beim Erstellen der Option Suche mit ausgecheckten Filtern speichern .
...
* ASSETS-29443: Unified Shell Hero bleibt sichtbar und anklickbar, wenn der Granite Shell-Header-Modus in &quot;Auswahl&quot;geändert wird.
...
* ASSETS-30434: Ereignis &quot;Verarbeitung abgeschlossen&quot;für Assets wurde nicht an Pipeline gesendet.
