...
| **[!UICONTROL Standardbild]** | Wenn bei einer Anfrage ein angefordertes Bild nicht gefunden werden kann, wird ein Standardbild zurückgegeben.<br>Siehe auch den Parameter [DefaultImage](https://experienceleague.adobe.com/de/docs/dynamic-media-developer-resources/image-serving-api/image-serving-api/attributes/r-is-cat-defaultimage) im Dynamic Media Viewer-Referenzhandbuch.<br>**HINWEIS** **&#x200B;**: Wenn für Ihr Dynamic Media Classic-Konto unter **[!UICONTROL Setup]** > **[!UICONTROL Application]** > **[!UICONTROL Publish setup]** in der Gruppe **[!UICONTROL Default Request Attributes]** ausgewählt ist, ruft Experience Manager es ab. Die Datei wird dann gespeichert und in diesem Feld verfügbar gemacht, wenn Sie die **[!UICONTROL Veröffentlichungseinstellungen für Dynamic Media]** zum ersten Mal öffnen. |
