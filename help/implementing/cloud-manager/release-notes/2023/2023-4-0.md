...
Die Version 2023.4.0 von Cloud Manager in AEM as a Cloud Service wurde am Freitag, 13. April 2023 veröffentlicht. Die nächste Version ist für den 11. Mai 2023 geplant.
...
* Wenn ein [Zertifikat](/help/implementing/cloud-manager/managing-ssl-certifications/introduction-to-ssl-certificates.md) abläuft, können [Domänennamen](/help/implementing/cloud-manager/custom-domain-names/introduction.md) und [IP-Zulassungslisten](/help/implementing/cloud-manager/ip-allow-lists/introduction.md), die mit dem Zertifikat verknüpft sind, nicht mehr aus dem CDN entfernt werden. In solchen Fällen bleibt die Site erreichbar.
