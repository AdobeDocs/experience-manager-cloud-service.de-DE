...
* Beim Erstellen [eines neuen Programms oder einer neuen Umgebung](/help/implementing/cloud-manager/getting-access-to-aem-in-cloud/program-types.md) ist der Name nun auf die Verwendung von alphanumerischen Zeichen und einen begrenzten Satz an Sonderzeichen beschränkt.
