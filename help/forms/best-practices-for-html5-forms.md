...
* Aktivieren Sie die Web-Komprimierung. Dadurch wird die Größe der Anfragen und Antworten reduziert, die aus einem Formular stammen. <!-- For details, see [Performance tuning of AEM Forms Server](https://helpx.adobe.com/de/aem-forms/6-3/performance-tuning-aem-forms.html)-->
