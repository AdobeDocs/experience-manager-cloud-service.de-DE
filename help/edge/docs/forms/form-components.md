...
Mit dem Formularblock können Sie mühelos Formulare erstellen, um erfasste Daten zu erfassen und zu speichern. Es unterstützt Komponenten, die auf allen HTML5 basieren [input-types](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#input_types) wie Text, E-Mail, Zahl, Datum und vieles mehr. Außerdem unterstützt [textarea](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/textarea), [select](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/select), und [fieldset](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/fieldset) -Elemente und umfasst Eingabebesuchungsfunktionen, die nativ zu HTML5 sind.

Der Formularblock generiert eine einheitliche HTML-Struktur für alle Feldtypen und Container (Bereiche), die die Konsistenz sicherstellen. Diese einheitliche Struktur erleichtert [Formular formatieren](/help/edge/docs/forms/style-theme-forms.md).


## Komponenteneigenschaften

Die folgenden Eigenschaften werden für Formularkomponenten des Formularblocks unterstützt:

<table>
 <tbody>
  <tr>
   <td><b>Eigenschaft</b> </td>
   <td><b>Formularkomponenten (Eingabetyp)</b> </td>
   <td><b>Details</b></td>
  </tr>
  <tr>
   <td>Name</td>
   <td>Alle Komponenten</td>
   <td> Eine Zeichenfolge, die einen Namen für die Komponente angibt. Die Daten der Komponente werden mit diesem Namen gesendet.
   </td>
  </tr>
  <tr>
   <td>Bezeichnung</td>
   <td>Alle Komponenten</td>
   <td> Der Titel dient als Beschriftung des Felds.
   </td>
  </tr>
  <tr>
   <td>Wert </td>
   <td>Alle Komponenten</td>
   <td> Der Anfangswert des Steuerelements. Bei Optionsfeld- und Kontrollkästchen-Komponenten ist dies der Wert/die Daten, der/die gesendet wird, wenn sie ausgewählt werden. Das Attribut value ist immer optional, sollte jedoch für Kontrollkästchen und Optionsfelder als obligatorisch betrachtet werden.
   </td>
  </tr>
    <tr>
   <td>Platzhalter</td>
