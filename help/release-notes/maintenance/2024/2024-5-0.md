...
2024.5.0: Die Funktionsaktivierung bietet den vollen Funktionsumfang für diese Wartungsversion. Weitere Informationen finden Sie in der [Versions-Roadmap von Experience Manager](https://experienceleague.adobe.com/de/docs/experience-manager-release-information/aem-release-updates/update-releases-roadmap).
...
* FORMS-13612: Bildschirmlesehilfen lesen jetzt Fehlermeldungen, Kurzbeschreibungen und lange Beschreibungen für Felder in kernkomponentenbasierten adaptiven Formularen laut. Darüber hinaus wurde Unterstützung dafür hinzugefügt, dass Eingaben in adaptiven Formularen invalidiert werden können, wenn das Formular Fehler enthält und nicht für die Übermittlung gültig ist.
...
* SITES-20121: Zulassen von defaultValue für Aufzählungsfelder.
* SITES-20146: Aktivieren der Vorschauversion/des Vergleichs für verschobene Seiten.
* SITES-20149: RTC: `[cq-wcm-launches-core]` Export der neuen API für Launches für CFs.
* SITES-20150: RTC: `[cq-command]` Fügen Sie neue Methoden zu vorhandener API hinzu.
* SITES-20238: `[RTC]` Pfizer-MVP - Hinzufügen der CF-API zum Auflösen von CF-Pfaden in IDs und umgekehrt.
...
* SITES-20342: `[Backend]` Veröffentlichen auf Ordnerebene - Filter hinzufügen, um nur Inhaltsfragmente zu veröffentlichen.
...
* SITES-20601: `[OpenAPI]` Aktualisieren der CF-Such-API, um nur direkte untergeordnete Inhaltsfragmente abzurufen.
* SITES-20653: Experiment-Startdatum und -Enddatum hinzufügen.
* SITES-20656: `[BE]` Option angeben, um beim Ersetzen einer Zeichenfolge die Groß-/Kleinschreibung zu berücksichtigen.
...
* SITES-20947: Unteraufgabe nach Inhaltsfragment-ID `[persistence]`.
* SITES-21012: Zusammenführen des Modell-Metadatenschemas mit dem Produkt.
* SITES-21043: `[CF][launches]` Leistungsverbesserungen am Side-Port für Cloud Service.
* SITES-21044: `[CF][launches]` asynchrone Seitenport-Payload-Implementierung in Cloud Service.
* SITES-21550: Benutzerdefinierte Metadaten: Zahl, Datum, Datum/Uhrzeit, Zeitfelder.
* SITES-21769: Verwenden Sie das Pfadpräfix :id/jcr/ für den Abruf von Ressourcen nach ID.
...
* SITES-11727: `[GQL]` vollständige Hydratation von Inhaltsfragmentverweisen fehlen Daten.
...
* SITES-20559: Beim `[MSM][XF][Lufthansa]` Rollout von Experience Fragments von der primären/Sprache in das Land/die Sprache werden Verweise nicht aktualisiert.
...
* SITES-20691: Die Vorlagenbeschränkung für Experience Fragments berücksichtigt nicht cq:allowedTemplates.
...
* SITES-21233: `[CoreCmp]` Akkordeon für GS1 US nach Upgrade auf 15860 beschädigt.
...
* ASSETS-32321: Die Auflösung des Nachbearbeitungs-Workflows schlägt fehl, wenn im Vorgängerordner der Unterknoten :contentjcr“ fehlt.
