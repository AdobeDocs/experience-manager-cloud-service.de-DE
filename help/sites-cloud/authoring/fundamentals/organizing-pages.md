...
>[!TIP]
>
>Es steht eine Reihe von [Tastaturbefehlen](/help/sites-cloud/authoring/getting-started/keyboard-shortcuts.md) in der Website-Konsole zur Verfügung, die eine effizientere Seitenorganisation ermöglichen.
...
1. Im letzten Schritt des Assistenten haben Sie folgende Möglichkeiten:
   ...
   * Geben Sie auf den drei Registerkarten die [Seiteneigenschaften](/help/sites-cloud/authoring/fundamentals/page-properties.md) ein, die Sie der neuen Seite zuweisen möchten, und wählen Sie dann **Erstellen**, um die Seite zu erstellen.
