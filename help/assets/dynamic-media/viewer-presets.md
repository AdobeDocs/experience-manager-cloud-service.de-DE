...
Sie müssen keine Viewer-Vorgaben veröffentlichen, je nachdem, welchen Veröffentlichungsmodus Sie verwenden.
...
1. Wählen Sie im linken Bereich einen Viewer aus, damit Sie ihn wie im rechten Bereich auf das Asset anwenden können. Sie können auch die [URL kopieren, um sie für andere Benutzer freizugeben](linking-urls-to-yourwebapplication.md).
