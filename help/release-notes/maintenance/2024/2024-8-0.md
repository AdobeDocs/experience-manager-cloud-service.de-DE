...
* SITES-23285 – Inhaltsfragmente-REST-API: Erstellen eines Endpunkts, um alle verfügbaren Sprachen aufzulisten.
* SITES-22857 – Inhaltsfragmente-REST-API: Kontrollkästchen-Aufzählungsfelder sollten nicht zulassen, dass mehrere Eigenschaften auf „false“ gesetzt sind.
* SITES-22813 – Inhaltsfragmente-REST-API: Definieren von Min.-/Max.-Eigenschaften für Aufzählungsfelder.
...
* SITES-22677 – Inhaltsfragmente-REST-API: Abrufen einer flachen Liste nachkommender Verweise.
...
* SITES-12209 - Verbessern Sie die Leistung des Richtlinien-Editors, indem Sie cq:policy zum Index hinzufügen.
...
* FORMS-14327 - Forms Service-APIs : Daten extrahieren:- gibt einen 500-Antwort-Code, wenn eine nicht interaktive PDF-Datei als Eingabe bereitgestellt wird.
...
* SITES-23637 – Inhaltsfragmente-REST-API: OpenAPI verwendet nicht den richtigen Werttyp für Aufzählungen.
...
* SITES-23535 – Content Fragments REST-API: Multifelder zum Aufzählen von Inhaltsfragmentmodellen weisen leere Werte auf.
* SITES-23534 – Content Fragments REST-API: ClassCastException bei Validierung von Inhaltsfragmenten.
* SITES-23524 – Anpassen des GraphQL BFF-Modellendpunkts zur Unterstützung von Aufzählungsfeldern mit mehreren Feldern.
* SITES-23467 – Inhaltsfragmente-REST-API: Suchmodelle schlagen aufgrund eines Cursor-Problems fehl.
...
* SITES-22814 – Content Fragments REST-API: Die Feldwerte der Kontrollkästchen-Aufzählungsfragmente sollten anhand der im Modell definierten Schlüssel geordnet werden.
...
* SITES-22279 – Content Fragments REST-API: Dem Inhaltsfragment fehlt das eindeutige Attribut für Aufzählungstypen.
* SITES-22203 – Inhaltsfragmente-REST-API: Ausrichten von Management-APIs, um auf dieselbe Situation zu reagieren.
* SITES-21973 – Inhaltsfragmente-REST-API: Dem Modell fehlt das eindeutige Attribut für Aufzählungstypen.
...
* FORMS-15818 - Komponentendeskriptoreintrag &quot;OSGI-INF/com.adobe.aemfd.docmanager.impl.*.xml“ konnte keine Anweisungen in Serverprotokollen gefunden werden. Dies sind harmlose Protokollanweisungen.
