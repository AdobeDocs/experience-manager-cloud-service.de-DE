...
description: Erfahren Sie mehr über Version 2026.2.0 von Cloud Manager in Adobe Experience Manager as a Cloud Service.
...
# Versionshinweise für Cloud Manager 2026.2.0 in Adobe Experience Manager as a Cloud Service {#release-notes}

<!-- https://wiki.corp.adobe.com/display/DMSArchitecture/%5BKT%5D+Cloud+Manager+2025.08.0+Release -->

Erfahren Sie mehr über Version 2026.2.0 von Cloud Manager in AEM (Adobe Experience Manager) as a Cloud Service.

Hier finden Sie die [aktuellen Versionshinweise für Adobe Experience Manager as a Cloud Service](/help/release-notes/release-notes-cloud/release-notes-current.md).

## Veröffentlichungsdaten {#release-date}

Die Version 2026.2.0 von Cloud Manager in AEM as a Cloud Service wurde am Donnerstag, dem Freitag, 5. Februar 2026 veröffentlicht.

Die Veröffentlichung der nächsten Version ist für Donnerstag, dem Freitag, 5. März 2026 geplant.
...
In der Cloud Manager-Version vom Februar 2026 gibt es keine signifikanten Fehlerbehebungen.
