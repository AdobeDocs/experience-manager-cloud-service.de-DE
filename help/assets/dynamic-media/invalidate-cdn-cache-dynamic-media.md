...
| *Einige URLs sind nicht richtig definiert. Korrigieren und übermitteln Sie sie erneut.* | Tritt auf, wenn die IPS CDN-Cache-Invalidierungs-API einen Fehler zurückgibt. Der Fehler gibt an, dass die URL auf ein anderes Unternehmen verweist oder dass die URL gemäß der von der IPS cdnCacheInvalidation-API durchgeführten Überprüfung ungültig ist. |
