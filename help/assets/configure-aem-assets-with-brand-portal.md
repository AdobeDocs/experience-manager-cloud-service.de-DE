...
Sie können eine neue Konfiguration auf Adobe I/O erstellen, um AEM Assets mit Markenportal zu konfigurieren.
...
* [Veröffentlichen von Assets aus AEM Assets im Markenportal](publish-to-brand-portal.md#publish-assets-to-bp)
...
Die Distribution enthält die folgenden Protokolle:
...
* DSTRQ3 (Anforderung 3): System löst eine weitere Anforderung aus, um den Ordner zu veröffentlichen, in dem das Asset vorhanden ist, und repliziert den Ordner im Markenportal.

**Reaktion** des Verteilungsagenten:
* queue-bpdistributionAgent0 (DSTRQ2): Das Asset wird im Markenportal veröffentlicht.
* queue-bpdistributionAgent0 (DSTRQ3): System repliziert den Ordner, der das Asset im Markenportal enthält.
