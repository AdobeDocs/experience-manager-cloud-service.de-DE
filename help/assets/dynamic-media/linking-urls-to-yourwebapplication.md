...
1. Wählen Sie links oben auf der Seite **[!UICONTROL Cloud Services]** aus, wählen Sie dann das Experience Manager-Symbol aus und navigieren Sie zu **[!UICONTROL Allgemein]** > **[!UICONTROL CRXDE Lite]**.
