...
## Verfügbarkeit von Kernkomponenten für adaptive Forms

Alle **AEM Forms as a Cloud Service**-Umgebungen enthalten native Unterstützung für die Erstellung von adaptivem Forms mithilfe von Kernkomponenten. Eine schrittweise Anleitung zur Erstellung von Formularen finden Sie unter [Erstellen eines adaptiven Formulars](/help/forms/create-an-adaptive-form.md).

### Aktivieren der Kernkomponenten für adaptive Forms für AEM 6.5
