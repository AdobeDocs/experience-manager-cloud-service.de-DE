...
* Die Bezeichnung **AEM Wartungsaktualisierung** wird sowohl für die Pipelineausführung als auch für Aktivitätsbildschirme angezeigt.
...
* Benutzer können nun ihre Cloud Manager-Rollen sehen, indem sie die Option &quot;Cloud Manager-Rollen anzeigen&quot;wählen, nachdem sie zum Benutzerprofilsymbol (oben rechts) von Experience Cloud navigiert sind.
...
* Beschriftungen, die die Antwort auf wichtige Metriken definieren, die den Schwellenwert nicht erreichen, wurden aus Gründen der Klarheit aktualisiert. Sie lesen nun **Sofort abbrechen** und **Sofort genehmigen** , um ihr wahres Verhalten widerzuspiegeln.
