...
* Self-Service-Verwaltung von [SSL-Zertifikaten](/help/implementing/cloud-manager/managing-ssl-certifications/introduction-to-ssl-certificates.md) und [Einführung in benutzerdefinierte Domänennamen](/help/implementing/cloud-manager/custom-domain-names/introduction.md).
...
* Die Option zum Anzeigen von Protokollen wurde deaktiviert, wenn die Protokolle nicht verfügbar waren. Dieses Problem wurde behoben und jetzt werden Nachrichten hinzugefügt, um Benutzer darüber zu informieren, warum Protokolle fehlen.
* Der Benutzeroberflächenstatus des Content Transfer Tool zeigte *FEHLGESCHLAGEN* an, wenn der Benutzer eine Aufnahme angehalten hatte. Dieses Problem wurde behoben, sodass stattdessen *STOPPED* angezeigt wird.
