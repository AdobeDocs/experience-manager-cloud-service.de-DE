...
* obere Symbolleiste: für wichtige Informationen und Aktionen
   ...
   * Alle Warnungen, die für das Fragment und Ihr Konto gültig sind. Wenn Sie beispielsweise nicht über die erforderlichen Berechtigungen zum Bearbeiten des Fragments verfügen oder ein anderer Benutzer die Fragmente [ausgecheckt](/help/sites-cloud/administering/content-fragments/managing.md#check-out-and-check-in) haben Sie nur Lesezugriff.
...
* die Liste der **[Varianten](#variations)**, die für dieses Fragment erstellt wurden:
   ...
   * Sie können [Varianten generieren](#generate-variations-ai) verwenden, um eine auf einer Eingabeaufforderung basierende Vorlage zu verwenden, die Adobe für einen bestimmten Anwendungsfall erstellt hat.
...
* **Vorlage**
   ...
   * Ermöglicht die Vorschau Ihres Inhaltsfragments mit **[Visualisierungsvorlagen (HTML)](#preview-with-visualization-html-templates)**.
