...
* Wenn ein Zertifikat abläuft, werden die mit dem Zertifikat verknüpften Domänennamen und IP-Zulassungslisten nicht mehr aus dem CDN entfernt.
   ...
   * [Die Cloud Manager-Benutzeroberfläche](/help/implementing/cloud-manager/managing-ssl-certifications/introduction-to-ssl-certificates.md) bietet sichtbarere Vorwarnungen, dass das SSL-Zertifikat bald abläuft.
