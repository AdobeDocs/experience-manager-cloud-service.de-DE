...
* **ContextHub**
   ...
   ![Schaltfläche &quot;Context Hub&quot;](/help/sites-cloud/authoring/assets/context-hub.png)
...
* **Complete** - Öffnet das Dialogfeld &quot; **Complete Work Item** &quot;
* **Delegate** - Öffnet den Dialog **zum Abschluss des Arbeitselements**
...
1. Neue Komponenten können auf zwei Arten aus dem Absatzsystem ausgewählt und hinzugefügt werden:
   ...
   * Wählen Sie die Option **Komponente einfügen** (+) in der Symbolleiste einer vorhandenen Komponente oder aus dem Feld **Komponenten hierher ziehen**.
      ...
      ![Komponente einfügen](/help/sites-cloud/authoring/assets/editing-insert-component.png)
...
* **Bearbeiten**
   ...
   [Je nach Komponententyp](/help/sites-cloud/authoring/fundamentals/components.md) können Sie den Inhalt der Komponente [bearbeiten](#edit-content). Häufig wird eine Symbolleiste angezeigt.

   Schaltfläche ![Bearbeiten](/help/sites-cloud/authoring/assets/editing-component-toolbar-edit.png)

* **Konfigurieren**

   [Je nach Komponententyp](/help/sites-cloud/authoring/fundamentals/components.md) können Sie die Eigenschaften der Komponente bearbeiten und konfigurieren. Häufig wird ein Dialogfeld geöffnet.
...
* **Übergeordnet**
   ...
   Auf diese Weise können Sie die übergeordnete Komponente der ausgewählten Komponente auswählen.

   ![Übergeordnete Schaltfläche](/help/sites-cloud/authoring/assets/editing-component-toolbar-parent.png)
...
* **Layout**
   ...
   ![Layout, Schaltfläche](/help/sites-cloud/authoring/assets/editing-component-toolbar-layout.png)

* **In Experience-Fragment-Variante umwandeln**

   Hierüber können Sie ein neues [Experience Fragment](/help/sites-cloud/authoring/fundamentals/experience-fragments.md) über die ausgewählte Komponente erstellen oder einem bestehenden Experience Fragment hinzufügen.

   ![Schaltfläche &quot;In Erlebnisfragment konvertieren&quot;](/help/sites-cloud/authoring/assets/editing-component-toolbar-xf.png)
...
* Bildkomponente
   ...
   >
   >Sie müssen ein Bild in die Komponente ziehen oder hochladen, bevor Sie mit der Bearbeitung beginnen können.
...
* Komponenten, die aus mehr als einer Basiskomponente erstellt wurden, müssen Sie zunächst bestätigen, welche Bearbeitungsoptionen Sie möchten:

### Drag-and-Drop von Assets in Komponenten {#drag-and-drop-assets-into-component}

Bei bestimmten Komponententypen (z. B. Bildern) können Sie Assets direkt aus dem Asset-Browser in die Komponente ziehen und dort ablegen, um den Inhalt zu aktualisieren.
...
>[!NOTE]
>
>Bei einigen Komponenten stehen im Vollbildmodus mehr Optionen zur Verfügung als im standardmäßigen ersetzenden Editor.
...
1. When in **Edit** mode of the sites console, selecting a component reveals the component&#39;s toolbar.
   ...
   ![Die Komponenten-Symbolleiste einer Seitenkomponente](/help/sites-cloud/authoring/assets/editing-layout-toolbar.png)
...
1. Durch das Auswählen der Layout-Aktion stehen folgende Funktionen zur Verfügung:
   ...
   * In der Komponenten-Symbolleiste stehen statt der Standard-Bearbeitungsaktionen nun Layout-Aktionen zur Verfügung.
   ![Eine Komponente im Layoutmodus](/help/sites-cloud/authoring/assets/editing-layout-mode.png)
...
1. After making the necessary layout changes, click the **Close** button in the component action menu to stop modifying the layout of the component. In der Komponenten-Symbolleiste stehen nun wieder die Standard-Bearbeitungsfunktionen zur Verfügung.
   ...
   ![Die Komponenten-Symbolleiste einer Seitenkomponente](/help/sites-cloud/authoring/assets/editing-layout-exit.png)
...
Vererbung ist der Mechanismus, bei dem Inhalte automatisch von einer Komponente in eine andere verschoben werden können. Vererbte Komponenten können sich aus diversen Szenarios ergeben, wie:

* Multi-Site-Management <!--[Multi site management](/help/sites-administering/msm.md)-->
* [Launch](/help/sites-cloud/authoring/launches/overview.md) (wenn er auf einer Live Copy basiert).

Sie können die Vererbung deaktivieren (und dann wieder aktivieren). Je nach Komponente kann dies über die Komponenten-Symbolleiste verfügbar sein, wenn sich die Komponente auf einer Seite befindet, die Teil einer Live-Kopie oder eines Live-Starts ist (basierend auf einer Live-Kopie).

![Eine Komponentensymbolleiste mit Vererbungsbeziehung](/help/sites-cloud/authoring/assets/editing-component-toolbar-inheritance.png)
...
* Vererbung erneut aktivieren (wenn die Vererbung bereits abgebrochen wurde)
   ...
   ![Schaltfläche &quot;Vererbung erneut aktivieren&quot;](/help/sites-cloud/authoring/assets/editing-reenable-inheritance.png)

* Die Rollout-Aktion steht auch in der Vorlage oder der Live Copy-Quelle zur Verfügung

   ![Rollout-Schaltfläche](/help/sites-cloud/authoring/assets/editing-rollout.png)

## Bearbeiten der Seitenvorlage {#editing-the-page-template}

Sie können einfach zum [Vorlageneditor](/help/sites-cloud/authoring/features/templates.md#editing-templates-template-authors) wechseln, indem Sie im Menü &quot; **Seiteninformationen&quot;die Option &quot;Vorlage** [bearbeiten&quot;auswählen](/help/sites-cloud/authoring/fundamentals/environment-tools.md#page-information).

Durch Auswählen der Seite in der [Spalten-](/help/sites-cloud/authoring/getting-started/basic-handling.md#column-view) oder der [Listenansicht](/help/sites-cloud/authoring/getting-started/basic-handling.md#list-view) können Sie schnell und einfach feststellen, auf welcher Vorlage die Seite basiert.
...
![Beispiel für den Live-Kopierstatus](/help/sites-cloud/authoring/assets/editing-live-copy-status.png)
...
>[!NOTE]
>
>Das WCM-Modus-Cookie ist für beide Vorschauoptionen festgelegt.
...
* **Sites-Konsole**
   ...
   1. Wählen Sie das Sperrsymbol aus.
      ...
      ![Sperrschaltfläche](/help/sites-cloud/authoring/assets/lock.png)
...
![Beispiel einer gesperrten Seite](/help/sites-cloud/authoring/assets/editing-locked-page.png)
...
![Die Schaltflächen &quot;Rückgängig&quot;und &quot;Wiederholen&quot;](/help/sites-cloud/authoring/assets/redo.png)
...
Das Verhalten der Befehle zum Rückgängigmachen und Wiederherstellen ähnelt dem in anderen Software. Verwenden Sie die Befehle, um den aktuellen Status Ihrer Webseite wiederherzustellen, während Sie Entscheidungen über Inhalte treffen. Wenn Sie beispielsweise einen Textabsatz an eine Stelle auf der Seite verschoben haben, können Sie ihn mithilfe des Befehls zum Rückgängigmachen wieder zurück an die ursprüngliche Stelle verschieben. Wenn Sie den Absatz dann doch wieder an die zuletzt verwendete Stelle verschieben möchten, können Sie mit dem Befehl zum Wiederholen quasi das „Rückgängigmachen rückgängig machen“.
