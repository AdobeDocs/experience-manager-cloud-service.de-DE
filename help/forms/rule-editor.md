...
1. Wählen Sie ein anderes Formularobjekt aus, in das Sie die Regel einfügen möchten, und wählen Sie **[!UICONTROL Einfügen]**. Darüber hinaus können Sie die Regel bearbeiten, um Änderungen daran vorzunehmen.
