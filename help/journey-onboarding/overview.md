...
* Den erforderlichen Benutzenden Zugriff auf AEM as a Cloud Service gewährt haben.
...
Die Onboarding-Tour wurde speziell für **System-Admins** von Kundinnen und Kunden geschrieben, für die AEM as a Cloud Service und AEM im Allgemeinen neu ist. Der Systemadministrator ist die Person, die nach Unterzeichnung Ihres AEM as a Cloud Service Vertrags von Adobe zuerst kontaktiert wird. Sie ist in der Regel die erste Person, die auf Ihre Ressourcen zugreift und diese auf AEM as a Cloud Service eingerichtet hat. Wenn Sie dieses Thema lesen, sind Sie wahrscheinlich Systemadministrator bzw. -administratorin.
...
[Eine Dokumentations-Tour](/help/journey-documentation/documentation-journeys.md) verbindet viele verschiedene, komplizierte Themen und Merkmale. Es bietet eine Erzählung, die es Lesenden, die neu bei AEM sind, ermöglicht, ein Geschäftsproblem von Anfang bis Ende zu verstehen und zu lösen, wobei nur minimale Vorkenntnisse zum Thema oder AEM vorausgesetzt werden.

Dokumentations-Touren werden auf der Grundlage von Best-Practice-Prinzipien entwickelt, die auf Informationen aus den neuesten Forschungsergebnissen von Adobe, bewährten Implementierungserfahrungen der Adobe-Fachleute und dem Feedback aus Kundenprojekten beruhen.
...
* [Onboarding in AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/moving-to-aem-as-a-cloud-service/onboarding.html?lang=de) – In diesem kurzen Video erhalten Sie einen Überblick über den Cloud Service-Onboarding-Prozess für AEM.
