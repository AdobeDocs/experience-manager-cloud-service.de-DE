...
description: Integration mit Git - Cloud Services
...
# Integration von Git mit Adobe Cloud Manager {#git-integration}
...
Im folgenden Video erfahren Sie mehr über die grundlegenden Verzweigungsstrategien.
