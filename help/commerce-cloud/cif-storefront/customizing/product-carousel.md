...
1. Fügen Sie eine neue Produktkarussellkomponente in den Haupt-Layout-Container auf der Seite ein.
...
1. Nun sollte eine Liste mit verfügbaren Produkten einer verbundenen Adobe Commerce-Instanz angezeigt werden.
   ...
   ![Verbundene Instanz](/help/commerce-cloud/cif-storefront/assets/connected-instance.png)

1. Produkte werden wie folgt mit Standardeigenschaften angezeigt:

   ![Angezeigtes Produkt mit Eigenschaften](/help/commerce-cloud/cif-storefront/assets/discount.png)
...
1. Erstellen Sie als Nächstes eine Implementierungsklasse `CustomCarouselImpl.java` unter `core/src/main/java/com/venia/core/models/commerce/CustomCarouselImpl.java`.
