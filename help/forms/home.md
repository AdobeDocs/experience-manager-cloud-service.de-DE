...
>[!TAB Adaptive Formulare].

Adaptive Forms ermöglicht es Unternehmen, interaktive, datengesteuerte Formulare für ihre Websites und andere digitale Kanäle zu erstellen und zu verwalten. Responsive, für Mobilgeräte geeignete Formulare sind nicht erforderlich. </br> </br> Adaptive Forms in AEM beinhaltet auch einen Drag &amp; Drop-Formular-Builder, mit dem nichttechnische Benutzer Formulare einfach erstellen und anpassen können. Dazu werden vordefinierte Formularkomponenten wie Textfelder, Dropdown-Menüs und Datumsauswahl verwendet. Dies ermöglicht eine schnellere Formularerstellung und macht eine umfangreiche Kodierung und Entwicklung nicht mehr erforderlich. </br> </br> Darüber hinaus bietet AEM Adaptive Forms verschiedene weitere Funktionen, darunter: <ul><li>Erweiterte Workflows für Routing, Genehmigung und Übermittlung von Formulardaten Echtzeit-Validierung und Fehlerprüfung, um Datengenauigkeit sicherzustellen </li><li>Integration mit Datenquellen und APIs von Drittanbietern zum Vorausfüllen von Formularfeldern oder zur Validierung von Daten </li><li>Erweiterte Analyse- und Berichterstellungsfunktionen zur Verfolgung von Formularnutzung, Konversionsraten und anderen Schlüsselmetriken </li><li>Integration mit Adobe Sign und DocuSign für E-Signaturen </li>

>[!TAB Service zur automatischen Formularkonvertierung]

Mit automated forms conversion Service können Unternehmen ältere PDF-basierte Formulare in interaktive, digitale Formulare konvertieren, die einfach verwaltet und online verteilt werden können. Der Service hilft bei Folgendem: <ul><li>Einsparung von manuellem Aufwand beim Konvertieren von Druckformularen in adaptive Formulare.</li><li>Anwendung von Mustern und entsprechender Validierungen während der Konvertierung</li><li>Generieren eines Datensatzdokuments während der Konvertierung </li><li>Gruppieren häufig vorkommender Felder in wiederverwendbare Formularfragmente </li> <li>Aktivierung von Adobe Analytics während der Konvertierung</li>

>[!TAB Kommunikations-API (Document Services)]

Kommunikations-APIs sind eine Reihe von RESTful-APIs (Application Programming Interfaces), mit denen Unternehmen die Erstellung, Verwaltung und Bereitstellung personalisierter, datengesteuerter Kommunikation automatisieren können. </br> </br> Diese APIs ermöglichen es Unternehmen auch, ihre Kommunikationsarbeitsabläufe in Drittanbietersysteme und -datenquellen zu integrieren, sodass sie zielgerichtete und personalisierte Nachrichten erstellen können, die durch bestimmte Ereignisse oder Benutzerverhalten ausgelöst werden. Zu den wichtigsten Funktionen der AEM Forms Communications-APIs gehören:<ul><li> Dynamische Inhaltsbereitstellung: Mit den APIs können Unternehmen dynamische Inhalte erstellen und bereitstellen, die auf individuelle Benutzer zugeschnitten sind, basierend auf ihren Voreinstellungen, Verhaltensweisen und früheren Interaktionen mit dem Unternehmen.</li> <li>Personalisierte Nachrichten: Die APIs ermöglichen es Unternehmen, ihre Kommunikation zu personalisieren, indem sie benutzerspezifische Daten wie Namen, Adressen und den Kaufverlauf einschließen.</li><li>Integration mit Back-End-Systemen: Die APIs können in eine Vielzahl von Back-End-Systemen integriert werden, darunter CRMs, Datenbanken und Plattformen zur Marketing-Automatisierung.</li><li> Generieren von Pixel Perfect-PDF-Dokumenten: Die APIs generieren pixelgenaue PDF-Dokumente, die mit benutzerspezifischen Daten und Inhalten angepasst werden. Diese Funktion ermöglicht es Unternehmen, hoch professionelle und polierte Dokumente wie Rechnungen, Verträge und Aussagen zu erstellen, die den Nutzern im PDF-Format zugestellt werden.

>[!TAB Advanced Analytics]

Der Dienst bietet OOTB-Unterstützung für die Verbindung mit Adobe Analytics. Die Verbindung von Formularen mit Adobe Analytics bietet verschiedene Vorteile für Unternehmen, darunter: <ul><li> Verbessertes Verständnis des Benutzerverhaltens: Durch die Verbindung von Formularen mit Adobe Analytics können Unternehmen ein tieferes Verständnis dafür erhalten, wie Benutzer mit ihren Formularen interagieren. Dazu gehören Einblicke in die Benutzerinteraktion, Konversionsraten, Ablagepunkte und andere Schlüsselmetriken, die Unternehmen dabei unterstützen, Bereiche zur Verbesserung zu identifizieren und ihre Formulare für bessere Benutzererlebnisse zu optimieren. </li><li>Bessere Ausrichtung der Marketing-Maßnahmen: Durch die Analyse des Benutzerverhaltens in Formularen können Unternehmen wertvolle Einblicke in Benutzerpräferenzen und -interessen gewinnen. Diese Informationen können verwendet werden, um Marketing-Maßnahmen gezielter auszurichten und effektivere Kampagnen zu erstellen, die Interaktionen und Konversionen fördern. </li><li> Verringerte Fehlerrate: Durch die Integration von Formularen in Adobe Analytics können Sie Einblicke in Felder mit den meisten Fehlern erhalten und die Datenqualität verbessern, was zu einer besseren Entscheidungsfindung und genaueren Einblicken führt. </li><li> Verbesserter ROI: Durch die Optimierung von Formularen auf der Grundlage von Einblicken aus Adobe Analytics können Unternehmen Konversionsraten verbessern und mehr Umsatz aus ihren digitalen Kanälen erzielen. Dies kann zu einem höheren ROI (Return on Investment) für Marketing- und digitale Initiativen führen, was Unternehmen dabei unterstützt, ihre Ziele zu erreichen und das Wachstum zu fördern.</li>
