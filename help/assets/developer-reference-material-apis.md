...
### Beispielskript zum Hochladen von Assets in AEM as a Cloud Service {#upload-assets-shell-script}

Der mehrstufige Upload-Prozess für den direkten Binärzugriff innerhalb AEM as a Cloud Service ist im folgenden Beispiel-Shell-Skript dargestellt `aem-upload.sh`:
