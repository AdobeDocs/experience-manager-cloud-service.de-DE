...
Für die Verwaltung Ihrer Workflows steht eine Reihe von Konsolen bereit. Use the [global navigation](/help/sites-cloud/authoring/getting-started/basic-handling.md#global-navigation) to open the **Tools** pane, then select **Workflow**:
...
## Instanzen des Sucharbeitsablaufs {#search-workflow-instances}

1. Using Navigation select **Tools**, then **Workflow**.
1. Wählen Sie **Instanzen** aus, um die Liste der aktuell ausgeführten Workflow-Instanzen anzuzeigen. Wählen Sie in der oberen Leiste links die Option **Filter** aus. Alternativ können Sie die Tastenanschläge alternativ mit Alt+1 verwenden. Das folgende Dialogfeld wird angezeigt:
