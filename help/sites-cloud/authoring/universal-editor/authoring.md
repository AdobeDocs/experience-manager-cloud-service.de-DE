...
#### Der Modal-Editor {#modal-editor}

Tippen Sie auf den Eintrag im [Bedienfeld Eigenschaften](#properties-rail), um einen modalen Editor zu öffnen, der eine größere Arbeitsfläche zum Bearbeiten von Rich-Text bietet.
...
* **Sortierte Liste**
   * Verwenden Sie die Tabulatortaste zum Einrücken und Umschalt+Tabulatortaste zum Ausrücken.
* **Link**
   * Geben Sie eine URL an oder verwenden Sie den Inhaltsbrowser, um einen Pfad in AEM auszuwählen.
...
* **Sonderzeichen**
   * Fügen Sie ein Sonderzeichen in Ihren Text ein.
