...
+ Dynamic Media {#dynamicmedia}
   ...
   + [Optional - Konfigurieren von Dynamic Media, Allgemeine Einstellungen](dynamic-media/dm-general-settings.md)
   + [Optional - Konfigurieren von Dynamic Media, Veröffentlichungseinstellungen](dynamic-media/dm-publish-settings.md)
