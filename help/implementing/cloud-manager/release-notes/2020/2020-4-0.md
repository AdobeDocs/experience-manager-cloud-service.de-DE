...
* Änderungen ermöglichen es den Benutzenden, das Programm direkt von der Programmkarte auf der Cloud Manager-Landingpage aus zu bearbeiten.
...
* Einzelne Schritte innerhalb des Prozesses der Umgebungserstellung erreichten früher als nötig einen Timeout und brachten den Prozess zum Scheitern.
...
* CX Enterprise-Benachrichtigungen wurden nicht konsistent empfangen.
