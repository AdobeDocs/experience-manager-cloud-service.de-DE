---
title: Best Practices für die SEO- und URL-Verwaltung für Adobe Experience Manager als Cloud-Dienst
seo-title: Best Practices für die SEO- und URL-Verwaltung für Adobe Experience Manager als Cloud-Dienst
...
# Best Practices für die SEO- und URL-Verwaltung für Adobe Experience Manager als Cloud-Dienst{#seo-and-url-management-best-practices-for-aem}

Suchmaschinenoptimierung (SEO) ist zu einem wichtigen Thema für viele Marketer geworden. Daher müssen SEO-Bedenken bei vielen Adobe Experience Manager (AEM) als Cloud Service-Projekte behoben werden.

This document first describes some [SEO best practices](#seo-best-practices) and recommendations for achieving these on an AEM as a Cloud Service implementation. Anschließend beschäftigt sich das Dokument intensiver mit einigen der [komplexeren Implementierungsschritte](#aem-configurations) aus dem ersten Abschnitt.
...
wird empfohlen, `mybrand.com/products/product-detail.1234.html`
...
>[!NOTE]
>
>Die `sling:alias` Eigenschaft kann beim Bearbeiten der Seiteneigenschaften mithilfe der [Alias-Eigenschaft festgelegt werden](/help/sites-cloud/authoring/fundamentals/page-properties.md#advanced).
