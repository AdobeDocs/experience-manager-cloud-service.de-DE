---
title: Einführung in Assets als a [!DNL Cloud Service]
description: Neue Funktionen in Assets als [!DNL Cloud Service].
contentOwner: AG
...
# Einführung in Assets als [!DNL Cloud Service] {#assets-cloud-service-introduction}
...
Im Folgenden werden die wichtigsten Vorteile von Assets als [!DNL Cloud Service] aufgeführt. Weitere Informationen finden Sie in der [Übersicht über Adobe Experience Manager as a [!DNL Cloud Service]](/help/overview/introduction.md).

* **Moderne Cloud-Dienste für die Asset-Verarbeitung**: Die neuen Asset-Mikrodienste sind ein Cloud-basierter, skalierbarer, zuverlässiger und leicht zu bedienender Asset-Verarbeitungsdienst.
