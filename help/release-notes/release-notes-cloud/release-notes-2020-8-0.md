...
* Verwenden Sie ein Profil zur Verarbeitung, um benutzerdefinierte Metadaten mithilfe des Datenverarbeitungsdienstes zu generieren. Siehe [Benutzerdefinierte Metadaten mithilfe von Profil](/help/assets/manage-metadata.md#metadata-compute-service).
...
* [!DNL AEM Desktop app] Version 2.0.3 ist jetzt verfügbar. Es verbessert die Kompatibilität mit dem [!DNL Experience Manager] 6.5.5 Service Pack und verfügt über eine aktualisierte Client-OS-Kompatibilitätstechnologie. [!DNL Windows] 7 und [!DNL macOS] Versionen vor 10.14 werden nicht unterstützt.
