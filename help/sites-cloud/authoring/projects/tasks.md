...
Um eine Aufgabe abzuschließen, wählen Sie die Aufgabe aus und klicken Sie auf **Fertig**. Fügen Sie Informationen zur Aufgabe hinzu und klicken Sie auf **Fertig**. Siehe [Ihr Posteingang](/help/sites-cloud/authoring/getting-started/inbox.md) für weitere Informationen.
