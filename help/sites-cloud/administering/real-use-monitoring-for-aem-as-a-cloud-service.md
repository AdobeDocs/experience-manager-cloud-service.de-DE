...
>[!NOTE]
>
>Adobe freut sich, die [GA-Rollout](/help/release-notes/release-notes-cloud/release-notes-current.md#real-use-monitoring) für den Real Use Monitoring-Dienst, die clientseitige Datenerfassung. Es handelt sich um einen automatisierten Dienst, für den keine Kundeneinrichtung erforderlich ist.
...
1. **Können Kunden die RUM-Service-Skripte in Drittanbietersysteme wie Dynatrace integrieren?**
