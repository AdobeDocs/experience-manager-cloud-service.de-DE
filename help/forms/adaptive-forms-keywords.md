...
# Schlüsselwörter für adaptive Formulare {#adaptive-forms-keywords}

Schlüsselwörter für adaptive Formulare sind vordefinierte, reservierte Bezeichner, die für adaptive Formulare eine besondere Bedeutung haben. Diese Schlüsselwörter können Sie in Ihren adaptiven Formularen nicht als Bezeichner verwenden. In der folgenden Tabelle sind alle Schlüsselwörter, die reservierte Bezeichner für adaptive Formulare sind, aufgeführt.
...
Außer den oben aufgeführten Stichwörtern sollten Sie es auch vermeiden, Namen zu verwenden, die den [JavaScript-APIs für adaptive Formulare](https://adobe.com/go/learn_aemforms_javascript_api_63_de) ähneln.
