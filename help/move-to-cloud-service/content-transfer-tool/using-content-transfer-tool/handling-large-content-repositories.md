...
Verwenden Sie auf der Seite mit den Containereigenschaften im Azure-Portal die Schaltfläche **Größe berechnen** , um die Größe des gesamten Inhalts im Container zu bestimmen. Zum Beispiel:
...
Sie können die Registerkarte Metriken des Containers verwenden, um die Größe des gesamten Inhalts im Container zu bestimmen. Zum Beispiel:
...
Erstellen Sie in der Quell-AEM-Instanz in `crx-quickstart/cloud-migration` eine neue Datei mit dem Namen azcopy.config .
...
Starten Sie die Autorenaufnahme über die CTT-Benutzeroberfläche. Weitere Informationen finden Sie im [Aufnahmeprozess](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/cloud-migration/content-transfer-tool/ingesting-content.html?lang=en).
...
Sobald Sie mit dem Umgang mit großen Content-Repositorys vertraut sind, um die Extraktions- und Aufnahmephasen der Inhaltstransferaktivität erheblich zu beschleunigen und Inhalte auf AEM as a Cloud Service zu verschieben, können Sie jetzt den Extraktionsprozess im Content Transfer Tool erlernen. Informationen zum Extrahieren Ihres Migrationssatzes aus dem Content Transfer Tool finden Sie unter [Extrahieren von Inhalt aus einer Quelle im Content Transfer Tool](/help/move-to-cloud-service/content-transfer-tool/using-content-transfer-tool/extracting-content.md) .