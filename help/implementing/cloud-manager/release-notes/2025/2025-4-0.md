...
* **(UI) Optimierung der Domain-Validierung**
  ...
  Beim Hinzufügen einer Domain zeigt Cloud Manager einen Fehler an, wenn diese bereits in einem Fastly-Konto installiert ist: &quot;*Domain bereits in Fastly installiert. Entfernen Sie sie vor dem Hinzufügen zu Cloud Service.*&quot;

## Private Beta-Programm {#private-beta-program}

Um vor der allgemeinen Veröffentlichung exklusiven Zugriff auf kommende Funktionen zu erhalten, nehmen Sie am privaten Beta-Programm von Cloud Manager teil.
...
>[!NOTE]
>
>Derzeit sind die standardmäßigen Pull-Anfrage-Code-Qualitätsprüfungen ausschließlich für GitHub-gehostete Repositorys. Eine Aktualisierung zur Erweiterung dieser Funktion auf andere Git-Anbieter ist jedoch in Arbeit.
