...
Inhalte haben ihren Anfang in der Autoreninstanz. Hier erstellen Ihre Inhaltsautoren ihre Inhalte. Die Autorenumgebung bietet verschiedene Tools für Autoren zum Erstellen, Organisieren und Wiederverwenden ihrer Inhalte.
...
1. Ihre Inhaltsautoren erstellen Ihre Headless-Inhalte in der Autoreninstanz.
...
Sie sollten sich jedoch der zusätzlichen zur Verfügung stehenden Hybridmöglichkeiten bewusst sein, sobald Sie AEM Headless-Funktionen verstehen. Wir legen diese Fälle im Folgenden zu Ihrer Kenntnisnahme dar. Am Ende der Tour werden Sie mit diesen Konzepten näher vertraut gemacht, falls eine solche Flexibilität für Ihr Projekt erforderlich ist.
...
In diesem Modell wird AEM nur zum Erstellen und Bereitstellen des Inhalts mithilfe von AEM Inhaltsfragmenten verwendet. Rendering und Interaktion mit dem Inhalt werden an die nutzende externe Anwendung delegiert, häufig eine Single Page Application (SPA).
...
* [Inhaltsmodellierer](#content-modeler)
* [Entwickler](#developer)

#### Administrator {#administrator}

Der Administrator ist für die grundlegende Einrichtung und Konfiguration Ihres Systems verantwortlich. Beispielsweise richtet der Administrator Ihr Unternehmen im User Management-System von Adobe ein, das auch Identity Management System (IMS) genannt wird. Der Administrator ist der erste Benutzer des Unternehmens, der eine Einladung per E-Mail von Adobe erhält, sobald Ihre Organisation von Adobe im IMS erstellt wurde. Der Administrator kann sich dann beim IMS anmelden und Benutzer oder andere Personas hinzufügen.

Sobald die Benutzer vom Administrator konfiguriert wurden, erhalten sie die Berechtigungen für den Zugriff auf alle AEM-Ressourcen, um ihre Arbeit als Mitwirkende für die Bereitstellung der Erlebnisanwendung mit AEM Headless zu erledigen.
...
Planen Sie die Übersetzung und lokale Anpassung ganz am Anfang des Projekts. Betrachten Sie den „Internationalisierungs-Projektmanager“ als eine separate Persona, dessen Aufgabe es ist zu definieren, welche Inhalte übersetzt werden sollen und welche nicht und welche übersetzten Inhalte von regionalen oder lokalen Inhaltserstellern geändert werden können.
...
Weitere Informationen zu AEM Workflows und Tools für die lokale Anpassung finden Sie im Abschnitt [Zusätzliche Ressourcen](#additional-resources).
...
* [Lokale Anpassung](#localization): AEM verwaltet die lokale Anpassung von Inhalten, indem Kopien von Inhalten in gebietsschemaspezifischen Ordnern verwaltet werden.
* Organisation: Ordner werden verwendet, um eine Inhaltshierarchie zu definieren, die zur Unterstützung der Anforderungen an die lokale Anpassung sowie zur logischen Verwaltung von Inhaltsfragmenten erforderlich ist.

AEM ermöglicht eine sehr flexible Inhaltsstruktur und eine Hierarchie kann beliebig groß sein. Es ist jedoch wichtig zu verstehen, dass Änderungen an der Ordnerstruktur unbeabsichtigte Folgen für bestehende Abfragen haben können, die [auf den Inhaltspfad angewiesen sind.](#developer) Daher kann eine klar definierte Hierarchie, die im Voraus festgelegt ist, für Ihre Inhaltsautoren äußerst hilfreich sein.
...
Inhaltsmodellierer analysieren die Anforderungen an die Daten, die „headless“ bereitgetellt werden müssen, und definieren die Struktur für diese Daten. Diese Strukturen werden in AEM [Inhaltsfragmentmodelle](#content-fragment-models) genannt. Inhaltsfragmentmodelle werden als Grundlage für die Inhaltsfragmente verwendet, die die Inhaltsautoren erstellen.
...
* [Einführung in die Architektur von Adobe Experience Manager as a Cloud Service](/help/core-concepts/architecture.md) – Grundlegendes zur Struktur von AEM as a Cloud Service
