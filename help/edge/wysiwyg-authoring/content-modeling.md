...
Das Modell dieser Komponenten ist Teil der [Bausteinvorlage für das WYSIWYG-Authoring mit Edge Delivery Services](https://github.com/adobe-rnd/aem-boilerplate-xwalk/blob/main/component-models.json#L2-L112).
...
* Die Entwicklerin oder der Entwickler kann eine [Modell-ID](/help/implementing/universal-editor/field-types.md#model-structure) definieren.
   * Die Modell-ID ist ein Verweis auf das Modell der Komponente, die die Felder definiert, welche der Autorin bzw. dem Autor im Bedienfeld „Eigenschaften“ zur Verfügung stehen.
