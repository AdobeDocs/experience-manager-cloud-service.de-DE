...
* Auf das [Lizenz-Dashboard](/help/implementing/cloud-manager/license-dashboard.md) kann jetzt über einen bestimmten Einstiegspunkt im linken [Seitenmenü](/help/implementing/cloud-manager/navigation.md) zugegriffen werden.
