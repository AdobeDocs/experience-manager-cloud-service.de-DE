...
Aktivieren Sie die Erweiterbarkeit der Benutzeroberfläche in Ihrem [!DNL AEM Assets View], um Ihrer [!DNL Assets View]-Benutzeroberfläche benutzerdefinierte UI-Komponenten hinzuzufügen, um bestimmte Geschäftsanforderungen zu erfüllen, die von den vorkonfigurierten Funktionen von [!DNL AEM Assets View] nicht erfüllt werden.\
