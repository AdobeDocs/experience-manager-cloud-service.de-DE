...
* Eine betriebsbereite [!DNL Experience Manager Assets] as a [!DNL Cloud Service] instance
...
1. Melden Sie sich bei Ihrer [!DNL Experience Manager Assets] Cloud-Instanz.
