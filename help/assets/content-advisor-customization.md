---
title: Inhaltsratgeber anpassen
description: Verwenden Sie Funktionen zum Anpassen von Content Advisor in Ihrer Anwendung.
role: Admin, User
...
# Anpassungen von Content Advisor {#content-advisor-customization}

Mit Content Advisor können Sie verschiedene Komponenten entsprechend Ihren Voreinstellungen, Anforderungen oder funktionalen Anforderungen anpassen. Sie können die folgenden Komponenten anpassen [Micro-Frontend Content Advisor](#overview-asset-selector.md):
...
Sie können die Verwendung eines abgelaufenen Assets anpassen, damit es auswählbar oder nicht auswählbar wird. Sie können anpassen, ob Sie das Ziehen eines abgelaufenen Assets per Drag-and-Drop auf die Arbeitsfläche des Inhaltsberaters zulassen möchten oder nicht. Verwenden Sie die folgenden Parameter, damit ein Asset auf der Arbeitsfläche nicht auswählbar wird:
...
## Hochladen in Content Advisor {#upload-in-content-advisor}

Sie können Dateien oder Ordner von Ihrem lokalen Dateisystem in Content Advisor hochladen. Um Dateien mit dem lokalen Dateisystem hochzuladen, müssen Sie im Allgemeinen eine Upload-Funktion verwenden, die von einem Content Advisor-Micro-Frontend-Programm bereitgestellt wird. Die `upload` Verschiedenen Codeausschnitte, die zum Aufrufen von Upload in Content Advisor erforderlich sind, umfassen:
