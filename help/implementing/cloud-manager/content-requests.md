...
>[!NOTE]
>Wenn eine API-Anfrage HTML oder JSON zurückgibt, das als Inhalt auf Seitenebene dient (z. B. bei der Headless-Bereitstellung), wird sie je nach Kontext als Inhaltsanfrage gezählt.
...
>[!NOTE]
>Wenn eine API-Anfrage eine HTML-Antwort zurückgibt, wird sie je nach Nutzungskontext als Inhaltsanfrage klassifiziert. API-Anfragen, die Nicht-UI-Daten zurückgeben, werden in der Regel ausgeschlossen.
