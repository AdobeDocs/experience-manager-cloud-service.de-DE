...
Die Aktivierung der Funktion 2024.7.0 bietet das vollständige Funktionsumfang für diese Wartungsversion. Weitere Informationen finden Sie in der [Experience Manager-Versions-Roadmap](https://experienceleague.adobe.com/de/docs/experience-manager-release-information/aem-release-updates/update-releases-roadmap).

### Verbesserungen {#enhancements-17098}

* SKYOPS-79817: Aktivieren Sie die Sling Feature Analyzer-Aufgabe für Dienstbenutzerzuordnungen.

### Behobene Probleme {#fixed-issues-17098}

* ASSETS-39665: Smart Crops Sync funktioniert nach der Migration von 6.5 auf AEMCS nicht mehr.
...
* GRANITE-52746: Alle Knotentypen werden nicht im Dialogfeld &quot;Knoten erstellen&quot;geladen.
...
* SKYOPS-80075: Probleme mit Umlauten in Asset-Namen, die eine Blockierung der Veröffentlichungswarteschlange (Mac) verursachen.
* SKYOPS-81032: Durch Anforderungen generierte Protokolle herausfiltern, um Protokolle bei Verwendung der erweiterten Protokollierung zu erhalten.
...
* SITES-21617: Machen Sie Seiteneigenschaften/Metadaten innerhalb der EU bearbeitbar.
* SITES-19614: Seitennummerierung des Tabelleneditors und unendlicher Bildlauf.
* SITES-22163: Verbesserte Unterstützung für Inhalte, die von der Veröffentlichungsstufe für Edge Delivery Sites bereitgestellt werden.
* SITES-22109: Verbesserte Handhabung der Nachbearbeitung von Rich-Text-Markups.
* SITES-22035: Verbesserte Handhabung von MSM und Launches.
* SITES-21839: Verbesserte Pfadzuordnung und Bereinigung für nicht von Edge Delivery bereitgestellte Inhalte.
