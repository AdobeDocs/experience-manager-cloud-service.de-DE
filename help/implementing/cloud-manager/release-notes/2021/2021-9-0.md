...
* Beim Versuch, eine IP-Zulassungsliste in einem Programm hinzuzufügen, das seinen Grenzwert erreicht hat, erhält der Benutzer jetzt eine klarere Nachricht. Diese Aktualisierung verbessert das Verständnis, indem sie angibt, dass die maximale Anzahl von IP-Zulassungslisten erreicht wurde.
