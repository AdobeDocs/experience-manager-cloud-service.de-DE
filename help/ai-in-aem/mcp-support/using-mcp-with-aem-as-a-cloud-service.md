...
Alle Anwendungen, die unter [Unterstützte MCP-Anwendungen](#supported-mcp-applications) aufgeführt sind, sind standardmäßig zulässig.
...
* **Assets-Suche**
  ...
  >[!NOTE]
  >
  >Senden Sie eine E-Mail an `aemagentsteam@adobe.com`, damit die Asset-Suche für Sie aktiviert wird. Fügen Sie den Organisationsnamen zusammen mit dem Anwendungsfall in die E-Mail ein.
