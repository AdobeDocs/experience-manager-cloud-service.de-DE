...
1. Wählen Sie in der seitlichen Navigationsleiste das Fenster **Umgebungen** für das ausgewählte Programm und dann die Umgebung aus, für die eine Umgebungsvariable erstellt werden soll.
...
>[!TIP]
>
>Wenn Sie mehrere Variablen hinzufügen möchten, wird empfohlen, die erste Variable hinzuzufügen, und dann die Schaltfläche **Hinzufügen** im Dialogfeld **Umgebungskonfiguration** zu verwenden, um die zusätzlichen Variablen hinzuzufügen. Auf diese Weise können Sie sie mit einer Aktualisierung zur Umgebung hinzufügen.
...
1. Wählen Sie im Bedienfeld „Navigation“ das Fenster **Umgebungen** für das ausgewählte Programm und dann die Umgebung aus, für die eine Umgebungsvariable geändert werden soll.
1. Wählen Sie in den Details der Umgebung die Registerkarte **Konfiguration** und dann oben rechts **Hinzufügen/Aktualisieren** aus, um das Dialogfeld **Umgebungskonfiguration** zu öffnen.
...
>[!TIP]
>
>Wenn Sie mehrere Variablen aktualisieren möchten, wird empfohlen, das Dialogfeld **Umgebungskonfiguration** zu verwenden, um alle erforderlichen Variablen gleichzeitig zu aktualisieren, bevor Sie auf **Speichern** tippen bzw. klicken. Auf diese Weise können Sie sie mit einer Aktualisierung zur Umgebung hinzufügen.
...
Neben Umgebungsvariablen gibt es auch Pipeline-Variablen, die während der Build-Phase verfügbar gemacht werden. Weitere Informationen zu Pipeline-Variablen finden Sie unter [Build-Umgebung](/help/implementing/cloud-manager/getting-access-to-aem-in-cloud/build-environment-details.md#pipeline-variables).
