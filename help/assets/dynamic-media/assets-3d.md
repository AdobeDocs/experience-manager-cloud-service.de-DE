...
1. Führen Sie während der **[!UICONTROL Bearbeitung]** einer Webseite einen der folgenden Schritte aus:
   ...
   * Löschen Sie `/editor.html` aus der Seiten-URL im Browser.
   ![
Ein vollständig interaktives 3D-Asset, wie in ](/help/assets/dynamic-media/assets/3d-asset-in-3d-mediaa.png)****

1. ![3D-Asset, das innerhalb der 3D-Medienkomponente](/help/assets/dynamic-media/assets/3d-asset-in-3d-mediaa.png)angezeigt wird Ein vollständig interaktives 3D-Asset, wie im **[!UICONTROL Vorschau]** -Modus angezeigt.
...
1. Tap **[!UICONTROL Edit]** to open the template.
   ...
   Wählen Sie rechts oben auf der Seite im Dropdown-Menü die Option **[!UICONTROL Strukturierungsmodus]** , falls diese noch nicht aktiv ist.](/help/assets/dynamic-media/assets/3d-media-component-structurea.png)
...
Wenn Sie Adobe Experience Manager als Web-Content-Management-System verwenden, können Sie Ihren Webseiten 3D-Elemente über die 3D-Medienkomponente hinzufügen.[](/help/assets/dynamic-media/adding-dynamic-media-assets-to-pages.md)
...
1. Öffnen Sie AEM Sites und wählen Sie die Webseite aus, der Sie die Dynamic Media 3D-Medienkomponente hinzufügen möchten.********
   ...
   Tap the **[!UICONTROL Edit]** (pencil) icon to open the page into the page editor. Stellen Sie sicher, dass rechts oben auf der Seite der **[!UICONTROL Bearbeitungsmodus]** ausgewählt ist.](/help/assets/dynamic-media/assets/3d-media-component-edita.png)
...
1. Tippen Sie in der Symbolleiste auf das Symbol für das seitliche Bedienfeld, um die Anzeige des Bedienfelds zu aktivieren bzw. zu aktivieren.****
   ...
   Tippen Sie im Seitenbedienfeld auf das Pluszeichen, um die Liste &quot; **[!UICONTROL Komponenten]** &quot;zu öffnen.](/help/assets/dynamic-media/assets/3d-assets-filtera.png)
...
1. ![3d-media-component-config](/help/assets/dynamic-media/assets/3d-media-component-configa.png)]**
   ...
   Wählen Sie im Dialogfeld &quot;3D-Medien&quot;aus der Dropdown-Liste &quot;Viewer-Vorgabe&quot;die Option &quot; **[!UICONTROL Größe]** &quot;, um der Komponente die Viewer-Vorgabe &quot;Größe&quot;zuzuweisen.](/help/assets/dynamic-media/assets/3d-media-component-edit-configa.png)
...
1. Suchen Sie im Seitenbedienfeld nach dem 3D-Asset, das Sie auf der bearbeiteten Seite Ansicht haben möchten, oder blättern Sie zu diesem.****
   ...
   Ziehen Sie das 3D-Asset aus dem Bedienfeld &quot;Assets&quot;und legen Sie es auf die Komponente &quot; **[!UICONTROL 3D-Medien]** &quot;ab, die Sie der Seite zuvor hinzugefügt haben.](/help/assets/dynamic-media/assets/3d-asset-adda.png)
...
Wenn Sie AEM als WCM verwenden, verwenden Sie diese Veröffentlichungsmethode, um die Dynamic Media-3D-Elemente direkt auf Ihrer Webseite hinzuzufügen.[](/help/assets/dynamic-media/publishing-dynamicmedia-assets.md)
...
1. Tippen Sie auf **[!UICONTROL Schließen]** , um das Dialogfeld zu verlassen und zur Seite mit den Asset-Details zurückzukehren.
   ...
   Tippen Sie in der Dropdown-Liste links neben dem Dateinamen des 3D-Assets auf **[!UICONTROL Darstellungen]**.](/help/assets/dynamic-media/assets/3d-asset-renditionsa.png)
...
1. ![3d-asset-renditions](/help/assets/dynamic-media/assets/3d-asset-renditionsa.png)]******
   ...
   * Das 3D-Asset wurde in das Dynamic Media Image Production System (IPS) aufgenommen.
   ![Das 3D-Asset wird veröffentlicht.](/help/assets/dynamic-media/assets/3d-asset-urla.png)
...
* Verwenden Sie die folgenden beiden Methoden zum Veröffentlichen von Dynamic Media-3D-Assets, wenn Sie AEM *nicht* als WCM verwenden.]******
   ...
   **[!UICONTROL URL]** - Verwenden Sie die **[!UICONTROL URL]** , wenn Sie ein Drittanbieter-Web-Content-Management-System verwenden und mit dem Dimensions-Viewer Dynamic Media 3D-Assets mit Ihren Webseiten verknüpfen möchten.](/help/assets/dynamic-media/linking-urls-to-yourwebapplication.md#obtaining-a-url-for-an-asset)
