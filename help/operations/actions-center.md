...
| Fehler bei der Splunk-Protokollweiterleitung | Vorfall | Überprüfen Sie, ob Ihr Splunk-Endpunkt in Ihrer AEM Cloud Service-Umgebung funktioniert und erreichbar ist. Weitere Informationen zur Protokollweiterleitung finden Sie in der Dokumentation zur [Splunk-Protokollweiterleitung](/help/implementing/developing/introduction/logging.md#splunk-logs) . Wenn Sie Hilfe bei der Fehlerbehebung benötigen oder Änderungen an Ihrer Protokollierungskonfiguration vornehmen müssen, erstellen Sie ein Support-Ticket mit Adobe. |
