...
* Verbesserungen an der [Indizierung](/help/operations/indexing.md) haben die Pipeline-Dauer bei der Bereitstellung neuer Indizes verkürzt. Verbesserungen variieren je nach Inhaltsprofil.
* Automatische [Aktualisierungen für Entwicklungsumgebungen](/help/implementing/cloud-manager/manage-environments.md#updating-environments) sind standardmäßig für neue Programme aktiviert, sodass Sie Zeit sparen, Aktualisierungen manuell ausführen zu müssen. Diese Aktualisierung wird schrittweise durchgeführt.
