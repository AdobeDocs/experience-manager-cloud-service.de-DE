...
description: Generieren Sie mithilfe von Experience Manager Assets-Workflows und ImageMagick FPO-Ausgabeformate (nur für Platzierung) neuer und vorhandener Assets.
...
Sie können überprüfen, ob die generierten FPO-Ausgabedarstellungen nach Abschluss des Workflows angezeigt werden. Klicken Sie in der Experience Manager Assets-Benutzeroberfläche auf das Asset, um eine große Vorschau zu öffnen. Öffnen Sie die linke Leiste und wählen Sie **[!UICONTROL Ausgabedarstellungen]** aus. Alternativ können Sie den Tastaturbefehl `Alt + 3` verwenden, wenn die Vorschau geöffnet ist.
