...
* Cloud Manager validiert jetzt nicht nur die Ablaufdaten für das [Hauptzertifikat](/help/implementing/cloud-manager/managing-ssl-certifications/introduction-to-ssl-certificates.md), sondern auch die der Zwischenzertifikate.
