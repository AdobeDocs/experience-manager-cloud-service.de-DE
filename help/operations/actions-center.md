...
| Seiten enthalten eine große Anzahl von Knoten | Proaktiv | Reduzieren Sie die Gesamtzahl der Knoten auf einer Seite. Siehe Abschnitt [Dokumentation zur Seitenkomplex](https://experienceleague.adobe.com/en/docs/experience-manager-pattern-detection/table-of-contents/pcx) | |
| Große Anzahl von laufenden Workflow-Instanzen | Proaktiv | Beenden Sie nicht mehr benötigte laufende Workflows. Erfahren Sie, wie [Bereinigungsauftrag konfigurieren](https://experienceleague.adobe.com/de/docs/experience-manager-cloud-service/content/operations/maintenance) |               |
...
| Benutzer, die direkt zu einer benutzerspezifischen Gruppe hinzugefügt wurden | Proaktiv | Benutzer müssen relevanten IMS-Gruppen hinzugefügt werden und diese IMS-Gruppen müssen als Mitglieder AEM Gruppen hinzugefügt werden. Ausrichten mit [Best Practices für IMS](/help/security/ims-support.md) | |
| Fehlender JCR-Inhalt | Proaktiv | Fügen Sie den fehlenden JCR-Inhaltsknoten hinzu. Siehe Abschnitt [Dokumentation zu Assets Content Validator](https://experienceleague.adobe.com/en/docs/experience-manager-pattern-detection/table-of-contents/acv) | |
| Abgeschlossene Workflows werden nicht gelöscht | Proaktiv | Minimieren Sie die Anzahl der Workflow-Instanzen und verbessern Sie die Leistung, indem Sie mehr als 90 Tage alte Workflow-Instanzen bereinigen. Erfahren Sie, wie [Wartungsaufgaben konfigurieren](https://experienceleague.adobe.com/de/docs/experience-manager-cloud-service/content/operations/maintenance) | |
| Fehlender Sling-Ressourcentyp in Seite | Proaktiv | Fügen Sie den Knoten fehlender Sling-Ressourcentypen hinzu. Siehe Abschnitt [Dokumentation zu Assets Content Validator](https://experienceleague.adobe.com/en/docs/experience-manager-pattern-detection/table-of-contents/acv) |
