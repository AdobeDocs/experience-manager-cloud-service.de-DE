...
* Auf das [Lizenz-Dashboard](/help/implementing/cloud-manager/license-dashboard.md) kann jetzt über einen eindeutigen Einstiegspunkt in der linken [Navigation](/help/implementing/cloud-manager/navigation.md) zugegriffen werden.
