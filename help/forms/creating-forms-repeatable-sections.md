...
1. Wählen Sie im Bearbeitungsmodus einen Bereich und dann ![cmppr](assets/cmppr.png) aus. Aktivieren Sie in der Randleiste unter „Eigenschaften“ **[!UICONTROL Bereich wiederholbar machen]**. Geben Sie Werte für die Felder **[!UICONTROL Maximum]** und **[!UICONTROL Minimum]** an.
...
1. Wählen Sie in einem Bereich, der wiederholt werden soll, ![cmppr](assets/cmppr.png) aus. Sie können die Eigenschaften des Bereichs in der Randleiste sehen. Aktivieren Sie die Registerkarte **Bereich wiederholbar machen** und geben Sie Werte für die Felder **Maximum** und **Minimum** ein.
