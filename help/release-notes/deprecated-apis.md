...
<tbody>
  ...
  <tr>
    ...
    <td>Util-Klassen, die mit Apache Xerces in Verbindung stehen, werden in nachfolgenden Versionen entfernt, was zu einer größeren Versionsänderung führt. Da diese Utils für die interne Verwendung in Filevault bestimmt sind, wird die API von der öffentlichen API-Oberfläche nicht mehr unterstützt.</td>
    <td>01.09.21</td>
    <td>30.10.21</td>
  </tr>
</tbody>
