...
* ASSETS-35923: `UnsupportedClassVersionError` im CM-Pipeline-Erstellungsschritt nach dem Upgrade der `aem-sdk-api`-Version auf `2024.2.15262.20240224T002940Z-231200`. **Erfordert Kundenaktion zum Festlegen der CM Java-Version auf 11**, siehe [Build-Umgebung/Festlegen der Maven JDK-Version](/help/implementing/cloud-manager/getting-access-to-aem-in-cloud/build-environment-details.md#alternate-maven-jdk-version).
